...
export default function Feature(props){
    ...
    const containerStyle = {
        ...
        backgroundImage: 'linear-gradient(rgba(0, 224, 255, 0.45), rgba(240, 56, 255, 0.55))', 
        borderRadius: '10px', 
        margin: '20px', 
        width: '18%'
      };
    ...
    if(props.hasButton){
        return (
            <div  style={containerStyle} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} onClick={handleOnClick(props.linkTo)}>
