...
export default function SelectedUser(props) {
    return (
        <div style={{backgroundImage: 'linear-gradient(rgba(0, 224, 255, 0.45), rgba(240, 56, 255, 0.55))', borderRadius: '10px', padding: '20px', margin: '20px', width: '25%', height: '70vh'}}>
            <div style={{display:'flex', justifyContent:'center', alignItems:'center', backgroundColor:'rgba(255, 255, 255, 0.70)', borderRadius:'10px', marginBottom:'16px'}}>
                <div style={{textAlign:'center', fontFamily: youngSerif, fontSize:'20px', width:'100%', padding:'6px'}}>{props.userDataset.userName}</div>
                {(props.userDataset.userRole === 'moderator') ? <div style={{textAlign:'center', borderRadius:'15px', backgroundColor:'rgba(0, 132, 255, .6)', opacity:'0.8', width:'50%', marginRight:'20px'}}>Moderator</div> : null}
            </div>
