...
export default function Feature(props){
    return (
        <div style={{backgroundImage: 'linear-gradient(rgba(0, 242, 255, 0.65), rgba(255, 0, 242, 0.65))', borderRadius: '10px', padding: '20px', margin: '20px', width: '350px'}}>
            ...
            <div style={{textAlign:'center'}}>{<Link href={"/" + props.linkTo} style = {{padding: '0px 10px 10px', fontFamily:'Young Serif', fontSize:'30px', textAlign:'center', backgroundColor:'rgba(205, 197, 248, 1)', color: 'gray', borderRadius:'7px'}}>...</Link>}</div>
        </div>
    )
}
