...
// const trendingTopics = require("../app/page")
// trendingTopics.formatInput()
// trendingTopics.extractKeywords()
// trendingTopics.generateCache()
...
test('generateCache() adds data to cache database if its not already there', async () => {
  ...
  let cache = await cacheCollection.findOne({collectionDate: '2022-09-28'})

  expect(cache).not.toBeNull()

  await cacheCollection.deleteOne({collectionDate: '2022-09-28'})
});
